...
INSERT INTO `library`.`book` (`id`, `title`, `author_id`, `number_of_copies`) VALUES ('4', 'book4', '4', '1');
INSERT INTO `library`.`book` (`id`, `title`, `author_id`, `number_of_copies`) VALUES ('5', 'book5', '5', '2');
INSERT INTO `library`.`book` (`id`, `title`, `author_id`, `number_of_copies`) VALUES ('6', 'book6', '1', '2');
