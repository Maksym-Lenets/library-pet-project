...
<head>
   ...
   <%-- <meta name="_csrf" content="${_csrf.token}"/>
    ...
    <script type="text/javascript" src="webjars/bootstrap/4.1.2/js/bootstrap.min.js" defer></script>
...
<s:url var="url_jqlib" value="${contextPath}/resources/js/jquery-3.6.0.min.js" />
